...
const MyJobs = () => {
  ...
  useEffect(() => {
    setIsLoading(true);
    fetch(`http://localhost:5000/myJobs/hjfv@gmail.com`)
      .then((res) => res.json())
      .then((data) => {
        setJobs(data);
    setIsLoading(false);
  ...
  <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded ">
    ...
    <div className="block w-full overflow-x-auto">
      <table className="items-center bg-transparent w-full border-collapse ">
        ...
        {
          isLoading ? (<div className="flex items-center justify-centerh-28"><p >Loading....</p></div>) : (
            <tbody>
              {
                ...
                <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                  ...
                  <button onClick={() => handleDelete(job._id)} className="bg-red-700 px-6 py-2 rounded -sm text-white">Delete</button>
                </td>
              </tr> )
              }
